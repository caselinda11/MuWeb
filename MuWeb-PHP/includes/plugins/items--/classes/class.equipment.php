...
class equipment{
    ...
    private $IsSet      = false;     #套装
    private $IsEarring  = false;     #耳环
    private $IsNotItems     = false;     #不是装备类物品
    private $IsWing     = false;     #翅膀
    private $Is4thWing  = false;     #四代
    private $IsSocket   = false;     #镶嵌
    private $IsExtItem  = false;     #时限
    private $IsPentagram = false;    #卷轴
    private $Is380Item   = false;    #380
...
//        $m_PeriodItemOption = (($buf[9] & 2)/2) & 1; //时限物品
        ...
        #镶嵌物品
        if($this->itemOption['Type'] == 2) $this->IsSocket = true;
     ...
     * @return string|void
     */
    private function getItemLevel($m_level)
    {
