...
<div class="card mb-3">
    ...
    <div class="card-body">
        <form class="form-horizontal mt-5" action="" method="post">
            <div class="form-group row justify-content-md-center">
                <label for="id" class="col-sm-4 col-form-label text-right">选择角色</label>
                <div class="col-sm-4">
            ...
            <div class="form-group row justify-content-md-center">
                <label for="price" class="col-sm-4 col-form-label text-right">旗帜售价</label>
                <div class="col-sm-4">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p class="alert alert-info">6、一旦售卖旗帜将会从背包中取出，下架可取出旗帜至角色保管箱！</p>
        </div>
    </div>
<?} catch(Exception $ex) {
