...
define('_TBL_MASTERLVL_', 'T_SkillTree_Info');
...
define('_TBL_GENS_', 'GensMember');
	define('_CLMN_GENS_NAME_', 'Name');
	define('_CLMN_GENS_TYPE_', 'Influence');#0-2
	define('_CLMN_GENS_POINT_', 'Class');   #0-14
	define('_CLMN_GENS_LEVEL_', 'Rank');    #0-3000
