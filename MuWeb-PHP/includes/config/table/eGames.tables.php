...
define('_TBL_CHR_', 'Character');
	...
	define('_CLMN_CHR_RSTS_', 'zs_count');
...
define('_TBL_GENS_', 'Character');
	...
	define('_CLMN_GENS_TYPE_',  'GenFamily');       #0-2
	define('_CLMN_GENS_LEVEL_', 'GenLevel');        #0-14
    define('_CLMN_GENS_POINT_', 'GenContribution'); #0-3000
...
$custom['character_class'] = [
    ...
    0	=> 	['魔法师', 		'DW',	'dw.jpg',		'base_stats' => ['str' => 18, 'agi' => 18, 'vit' => 15, 'ene' => 30, 'cmd' => 0]],
