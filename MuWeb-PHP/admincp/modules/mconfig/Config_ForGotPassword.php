...
function saveChanges() {
	...
	$xmlPath = __PATH_INCLUDES_CONFIGS_MODULE__.'forgotpassword.xml';
...
?>
<div class="card">
    <div class="card-header">忘记密码设置</div>
    <div class="card-body">
<form action="" method="post">
	<table class="table table-striped table-bordered table-hover module_config_tables">
		<tr>
			<th style="width: 60%"><strong>模块状态</strong><span class="ml-3 text-muted">启用/禁用 忘记密码模块</span></th>
			<td>
