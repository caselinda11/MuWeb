...
<!--                    </li>-->
    ...
    <div class="content-page">
                    ...
                    <ul class="list-inline float-right mb-0">
                        <li class="list-inline-item dropdown">
                            <div class=" d-none d-lg-block visible-lg-block">
                                <i class="fa fa-exclamation-triangle text-danger"></i> <span class="text-danger">本网站授权给: <strong><?=key_encrypt(KEY,'D','heilong')?></strong>，盗版必究。</span>
                            </div>
                        </li>
                        <li class="list-inline-item dropdown">
        ...
        <!-- content -->
        <footer class="footer">
            © 2020 奇迹网站系统 by <a href="//wpa.qq.com/msgrd?V=1&uin=827916830&Menu=yes" title="">风行</a>
        </footer>
    </div>
